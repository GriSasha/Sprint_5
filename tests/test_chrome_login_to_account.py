...
def test_login_on_the_main_page(browser, reg_login, reg_password):
...
def test_login_by_personal_account_button(browser, reg_login, reg_password):
...
def test_login_by_registration_form(browser, reg_login, reg_password):
...
def test_login_by_password_recovery_form(browser, reg_login, reg_password):
